...
<head>
    ...
    <title>{Name} Racing Team - Auto</title>
        ...
        <div class="row">
            <div class="col-md-10 col-centered" style="min-height: 502px;">
                <div class="page-header">
                    <h1>
                        Auto <small>Qui troverai tutte le informazioni relative alla macchina</small>
                    </h1>
                </div>
                <p align="center">
                    <img src="./img/auto.jpg" style="border: 1px solid #000"><br /><br />
                    Coming soon
                    <br /><br />
                </p>
            </div>
